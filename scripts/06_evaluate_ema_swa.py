"""
Evaluate EMA/SWA models on clean and corrupted CIFAR-100 data.

Usage:
    python scripts/06_evaluate_ema_swa.py
"""
...
class EMA_SWA_Loader:
    """
    Load and handle files from a single EMA/SWA directory containing:
    ...
    def __init__(self, ema_swa_dir: Path, device, model_name: str = "resnet50", num_classes: int = 100, dropout: float = 0.0):
    ...
    def load_model(self, checkpoint_path):
        ...
        model = get_model(self.model_name, num_classes=self.num_classes, dropout=self.dropout).to(self.device)
