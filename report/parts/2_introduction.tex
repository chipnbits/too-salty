...
\textbf{How much shared training is required for souping to be effective?} Models originating from the same pre-trained model can soup effectively, but how much shared training is required? We investigate varying the number of shared pre-training epochs before splitting into fine-tuned variant models.\\
