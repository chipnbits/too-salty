...
\begin{figure}[ht]
  ...
  \includegraphics[width=0.8\linewidth]{./figures/soup_gain_vs_kl.png}
    \Description{A scatter plot figure showing KL divergence of logits against soup gain.}
...
\begin{figure}[ht]
  ...
  \Description{A scatter plot figure showing KL divergence of logits against soup gain for positive soups only.}
\end{figure}
...
\begin{figure}[ht]
  ...
  \Description{A line plot figure showing probability of positive soup gain of models B and C against the number of positive soups with model A.}
\end{figure}
...
\begin{figure}[ht]
  ...
  \Description{A scatter plot figure showing 104 initially trained models embedded in 2-dimensions using distance metric based on soup gain. Edges indicate positive soup gain. Color denotes the branching epoch.}
\end{figure}
