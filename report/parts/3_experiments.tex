...
We test whether souping can help reduce the \emph{robustness gap}, the gap between the test set and corrupted set loss. A mean and median difference in robustness gap before and after souping of approximately, with a plot of the CDF shown in Figure~\ref{fig:soup_robustness_cdf}. We conclude that souping does not reduce the robustness gap.
