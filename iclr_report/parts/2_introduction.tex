...
Soup gain loses information about the accuracy that the soup and the parents obtain. We investigate the relationship between soup gain and accuracy and compare their cumulative distribution functions (CDF) in Figures~\ref{fig:acc_vs_gain} and~\ref{fig:clean_acc_cdf}. We find that they are strongly related, and it is therefore sufficient to consider only the soup gain.